...
3. Use the `register_group` MCP tool with the JID, name, folder, trigger, the exact selected `allowed_tools` and `enabled_skills`, and the chosen `requiresTrigger` setting
...
```json
{
  "1234567890@g.us": {
    "name": "Research Group",
    "folder": "whatsapp_research-group",
    "trigger": "@Andy",
    "added_at": "2026-01-31T12:00:00Z",
    "containerConfig": {
