...
export interface ContainerConfigRow {
  ...
  shared_resources: string; // JSON: string[] - always explicit, never 'all'
  updated_at: string;
}
...
// ── Legacy types — kept for task-scheduler.ts compatibility ──

/** @deprecated Legacy group type used by task-scheduler.ts */
