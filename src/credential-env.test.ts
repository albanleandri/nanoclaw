...
describe.skipIf(!envExists)(
  'credential-env: .env does not contain raw credentials',
  () => {
...
describe.skipIf(!envExists)(
  'credential-env: OneCLI gateway is configured',
  () => {
...
describe.skipIf(!envExists)(
  'credential-env: required secrets are preserved',
  () => {
